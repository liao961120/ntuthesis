...
acknowledgements: |
  `r paste(readLines("_acknowledge.md", encoding = "UTF-8"), collapse = "\n  ")`
abstract-zh: |
  `r x=readLines("_abstract-zh.md", encoding = "UTF-8"); paste(x, collapse = "\n  ")`
abstract-en: |
  `r x=readLines("_abstract-en.md", encoding = "UTF-8"); paste(x, collapse = "\n  ")`
---
