...
\usepackage[printwatermark]{xwatermark}
  ...
  \newwatermark*[allpages,xpos=6.1725cm,ypos=10.5225cm,scale=0.5]{\includegraphics{watermark2.pdf}}
...
This is a \emph{sample} book written in \textbf{R Markdown} (Allaire et
