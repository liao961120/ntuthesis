...
<!--
`r if (knitr::is_latex_output()) '# 附錄 {-}'`
`r if (knitr::is_html_output()) '# (APPENDIX) 附錄 {-}'`

`r if (knitr::is_latex_output()) '## LaTeX  文獻引用  {#latex-cite-pkg -}'`
`r if (knitr::is_html_output()) '# LaTeX  文獻引用  {#latex-cite-pkg}'`
-->
