...
\keywords{R Markdown, Bookdown, Reproducible Research}{R Markdown, Bookdown, 可重製研究}
...
\begin{abstractzh}
中文摘要。中文摘要。\emph{中文摘要}。中文摘要。中文摘要。中文摘要。中文摘要。
...
\begin{abstracten}
This is an abstract \textbf{written} in English. This is an abstract
written in English.
\bigbreak
