...
abstract-en: |
  `r x=readLines("../_abstract-en.Rmd"); paste(x[-length(x)], collapse = '\n  ')`
abstract-zh: |
  `r x=readLines("../_abstract-zh.Rmd"); paste(x[-length(x)], collapse = '\n  ')`
keyword-en: |
  `r x=readLines('../_abstract-en.Rmd'); paste(x[length(x)])`
keyword-zh: |
  `r x=readLines('../_abstract-zh.Rmd'); paste(x[length(x)])`
link-citations: yes
