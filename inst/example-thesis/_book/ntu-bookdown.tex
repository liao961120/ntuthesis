...
\NormalTok{ggplot(data = iris) +}
\NormalTok{  geom_point(aes(x = Sepal.Length, }
...
\NormalTok{```\{r dia, fig.cap='(ref:dia)'\}}
...
{\centering \includegraphics[width=1\linewidth]{ntu-bookdown_files/figure-latex/foo-1} 
...
\caption{\label{tab:mtcar}Dynamic variable in caption: 2018-11-01 18:00:38.}
\centering
