...
對於有興趣以 `ntuthesis` 撰寫他校論文模板者，我們建議將完成的模板貢獻至此套件^[可使用 Email 直接將論文資料夾壓縮寄過來]，讓更多人受益。下文將說明模板的製作方式，幫助讀者擴充此套件。在開始閱讀前，建議先閱讀過 `ntuthesis` 的[使用說明](/ntuthesis/doc)
若有任何問題，歡迎[來信](mailto:liao961120@gmail.com)詢問。
