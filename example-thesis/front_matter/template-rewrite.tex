...
% Trad Ch font-family
\setCJKmainfont[AutoFakeBold=2.5,AutoFakeSlant=.3]{kaiti}
...
%   BoldItalicFont={TimesNewRoman-bold_italic.ttf}
%   ]{TimesNewRoman-regular.ttf}
% $endif$

% $if(cjk-mainfont)$
%     \setCJKmainfont[AutoFakeBold=2.5, AutoFakeSlant=.3]{$cjk-mainfont$}
% $else$
%     \setCJKmainfont[AutoFakeBold=2.5, AutoFakeSlant=.4]{kaiti.ttf}
% $endif$
